...
class Agent(agent.Agent):
    def __init__(self, address, ordinal):
        ...
        self[2] = atom.Atom(domain=domain.BoundedInt(1,30),init=30,policy=atom.default_policy(self.__row_size),names='row size')
        self[3] = atom.Atom(domain=domain.BoundedInt(1,5),init=5,policy=atom.default_policy(self.__col_size),names='col size')
        self[4] = atom.Atom(domain=domain.BoundedInt(0,9999),init=3123,policy=atom.default_policy(self.__server_port),names='server port')
