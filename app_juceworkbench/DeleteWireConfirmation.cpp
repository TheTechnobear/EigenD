...
//==============================================================================
DeleteWireConfirmation::DeleteWireConfirmation (std::vector<String> wires)
{
    ...
    addAndMakeVisible (label = new Label ("new label",
                                          TRANS("The following connections will be removed")));
    ...
    //[UserPreSize]
    label->setText("The following connections will be removed:",dontSendNotification);
    okPressed_=false;
...
DeleteWireConfirmation::~DeleteWireConfirmation()
{
...
//==============================================================================
void DeleteWireConfirmation::paint (Graphics& g)
{
...
void DeleteWireConfirmation::resized()
{
    okButton->setBounds (408, 208, 71, 24);
    cancelButton->setBounds (320, 208, 71, 24);
    label->setBounds (12, 8, 272, 24);
    toggleButton->setBounds (8, 176, 150, 24);
    textBox->setBounds (16, 40, 464, 128);
    //[UserResized] Add your own custom resize handling here..
    //[/UserResized]
}

void DeleteWireConfirmation::buttonClicked (Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="DeleteWireConfirmation" componentName=""
                 parentClasses="public Component" constructorParams="std::vector&lt;String&gt; wires"
  ...
  <BACKGROUND backgroundColour="ffffffff">
    <RECT pos="0 0 100% 100%" fill="linear: 96 0, 104 248, 0=ff060505, 1=ff757775"
          hasStroke="0"/>
  </BACKGROUND>
  ...
  <TEXTBUTTON name="cancelButton" id="e058ee11d9e251b0" memberName="cancelButton"
              virtualName="" explicitFocusOrder="0" pos="320 208 71 24" bgColOff="ffaeaeae"
  ...
  <LABEL name="new label" id="cf632a1aa060f6f0" memberName="label" virtualName=""
         explicitFocusOrder="0" pos="12 8 272 24" textCol="ffffffff" edTextCol="ff000000"
         edBkgCol="0" labelText="The following connections will be removed"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
  <TOGGLEBUTTON name="new toggle button" id="ebc24f529e7bdcaa" memberName="toggleButton"
                virtualName="" explicitFocusOrder="0" pos="8 176 150 24" txtcol="ffffffff"
                buttonText="don't show this again" connectedEdges="0" needsCallback="1"
                radioGroupId="0" state="0"/>
  <TEXTEDITOR name="textBox" id="4539c91fbb420454" memberName="textBox" virtualName=""
              explicitFocusOrder="0" pos="16 40 464 128" initialText="" multiline="1"
