...
//==============================================================================
DeleteRouteConfirmation::DeleteRouteConfirmation (std::vector<String> wires)
{
    ...
    addAndMakeVisible (label = new Label ("new label",
                                          TRANS("The following wires will be removed from all trunks and hooks:")));
    ...
    //[UserPreSize]
    label->setText("The following wires will be removed from all trunks and hooks:",dontSendNotification);
    okPressed_=false;
    dontShowAgain_=false;
    String wireString=String();
    for(std::vector<String>:: iterator i=wires.begin();i!=wires.end();i++)
    {
        wireString=wireString+(*i)+"\n";
    }
    textBox->setText(wireString);
...
DeleteRouteConfirmation::~DeleteRouteConfirmation()
{
...
//==============================================================================
void DeleteRouteConfirmation::paint (Graphics& g)
{
...
void DeleteRouteConfirmation::resized()
{
    okButton->setBounds (408, 208, 71, 24);
    cancelButton->setBounds (328, 208, 71, 24);
    label->setBounds (20, 24, 432, 24);
    toggleButton->setBounds (24, 184, 150, 24);
    textBox->setBounds (24, 56, 456, 120);
    //[UserResized] Add your own custom resize handling here..
    //[/UserResized]
}

void DeleteRouteConfirmation::buttonClicked (Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="DeleteRouteConfirmation"
                 componentName="" parentClasses="public Component" constructorParams="std::vector&lt;String&gt; wires"
                 variableInitialisers="" snapPixels="4" snapActive="1" snapShown="1"
                 overlayOpacity="0.330" fixedSize="1" initialWidth="500" initialHeight="250">
  ...
  <TEXTBUTTON name="okButton" id="e2aadca74a756fb3" memberName="okButton" virtualName=""
              explicitFocusOrder="0" pos="408 208 71 24" bgColOff="ffaeaeae"
              buttonText="OK" connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="cancelButton" id="e058ee11d9e251b0" memberName="cancelButton"
              virtualName="" explicitFocusOrder="0" pos="328 208 71 24" bgColOff="ffaeaeae"
  ...
  <LABEL name="new label" id="cf632a1aa060f6f0" memberName="label" virtualName=""
         explicitFocusOrder="0" pos="20 24 432 24" textCol="ffffffff"
         edTextCol="ff000000" edBkgCol="0" labelText="The following wires will be removed from all trunks and hooks:"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default font" fontsize="15" bold="0" italic="0" justification="33"/>
  <TOGGLEBUTTON name="new toggle button" id="ebc24f529e7bdcaa" memberName="toggleButton"
                virtualName="" explicitFocusOrder="0" pos="24 184 150 24" txtcol="ffffffff"
                buttonText="don't show this again" connectedEdges="0" needsCallback="1"
                radioGroupId="0" state="0"/>
  <TEXTEDITOR name="textBox" id="402ba61efdc280e7" memberName="textBox" virtualName=""
              explicitFocusOrder="0" pos="24 56 456 120" initialText="" multiline="1"
