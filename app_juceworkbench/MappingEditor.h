...
#ifndef __JUCE_HEADER_2A79104127B1106A__
#define __JUCE_HEADER_2A79104127B1106A__
...
public:
    //==============================================================================
    MappingEditor (Atom* atom, String name, ToolManager* tm);
    ~MappingEditor();
...
private:
    ...
    ToolManager* tm_;
    int mode_;
    void setToEditorMode();
    void setToKeyboardMode();
    //[/UserVariables]

    //==============================================================================
    ScopedPointer<GroupComponent> groupComponent;
    ScopedPointer<MusicalMappingComponent> mmc_;
    ScopedPointer<TextButton> chooseButton;
    ScopedPointer<ToggleButton> toggleButton;
    ScopedPointer<Slider> slider;
    ScopedPointer<Label> label;
    ScopedPointer<TextButton> fetchButton;
...
#endif   // __JUCE_HEADER_2A79104127B1106A__
