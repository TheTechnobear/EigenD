...
KeyToCourseTextEditor::KeyToCourseTextEditor(String name):TextEditor(name)
{
}

void KeyToCourseTextEditor::focusGained(FocusChangeType cause)
{
    TextEditor::focusGained(cause);
    //std::cout<<"FocusGained "<<cause<<std::endl;
    if(cause!=2)
    {
        KeyToCoursePropertyEditor* c=dynamic_cast<KeyToCoursePropertyEditor*>(getParentComponent());
        if(c!=0)
        {
            c->showWarning();
        }
...
//==============================================================================
KeyToCoursePropertyEditor::KeyToCoursePropertyEditor (Atom* atom, ToolManager* tm)
    : atom_(atom), tm_(tm)
{
    ...
    addAndMakeVisible (textEditor = new KeyToCourseTextEditor ("new text editor"));
...
KeyToCoursePropertyEditor::~KeyToCoursePropertyEditor()
{
...
//==============================================================================
void KeyToCoursePropertyEditor::paint (Graphics& g)
{
...
void KeyToCoursePropertyEditor::resized()
{
...
void KeyToCoursePropertyEditor::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    if (buttonThatWasClicked == editButton)
    {
        ...
        mappingEditor_=new KeyToCourseEditor(atom_,name_,tm_);
...
void KeyToCoursePropertyEditor::refreshValue()
{
...
String KeyToCoursePropertyEditor::formatTooltip(String s)
{
    int endIndex=100;
    int startIndex=0;
...
void KeyToCoursePropertyEditor::setItem(String name, String value)
{
    name_=name;
...
void KeyToCoursePropertyEditor::setAtom(Atom* atom)
{
    atom_=atom;
}

void KeyToCoursePropertyEditor::textEditorTextChanged(TextEditor &editor)
{
//    if(ready_)
//    {
...
void KeyToCoursePropertyEditor::textEditorReturnKeyPressed(TextEditor &editor)
{
...
void KeyToCoursePropertyEditor::showWarning()
{
...
void KeyToCoursePropertyEditor::setIndent(int indent)
{
...
<JUCER_COMPONENT documentType="Component" className="KeyToCoursePropertyEditor"
  ...
  <TEXTEDITOR name="new text editor" id="47f2e7b2f1fb4881" memberName="textEditor"
              virtualName="KeyToCourseTextEditor" explicitFocusOrder="0" pos="296R 8 216 16"
