...
//==============================================================================
ErrorReportComponent::ErrorReportComponent (String err1,String err2)
{
    ...
    //[UserPreSize]
    label->setText(err1,dontSendNotification);
    label2->setText(err2,dontSendNotification);
    //[/UserPreSize]
...
ErrorReportComponent::~ErrorReportComponent()
{
...
//==============================================================================
void ErrorReportComponent::paint (Graphics& g)
{
...
void ErrorReportComponent::resized()
{
    okButton->setBounds (120, 104, 71, 24);
    label->setBounds (16, 24, 272, 24);
    label2->setBounds (16, 56, 272, 24);
    //[UserResized] Add your own custom resize handling here..
    //[/UserResized]
}

void ErrorReportComponent::buttonClicked (Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="ErrorReportComponent" componentName=""
                 parentClasses="public Component" constructorParams="String err1,String err2"
                 variableInitialisers="" snapPixels="8" snapActive="1" snapShown="1"
                 overlayOpacity="0.330" fixedSize="1" initialWidth="300" initialHeight="140">
  ...
  <LABEL name="new label" id="cf632a1aa060f6f0" memberName="label" virtualName=""
         explicitFocusOrder="0" pos="16 24 272 24" textCol="ffffffff"
         edTextCol="ff000000" edBkgCol="0" labelText="An error occurred"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
  <LABEL name="new label" id="82dddf9486afd219" memberName="label2" virtualName=""
         explicitFocusOrder="0" pos="16 56 272 24" textCol="ffffffff"
